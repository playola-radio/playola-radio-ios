...
public protocol FRadioPlayerObserver: AnyObject {
   ...
   */
  func radioPlayer(
    _ player: FRadioPlayer, playTimeDidChange currentTime: TimeInterval, duration: TimeInterval)
}

// Default empty implementations

extension FRadioPlayerObserver {
  public func radioPlayer(_ player: FRadioPlayer, playerStateDidChange state: FRadioPlayer.State) {}
  public func radioPlayer(
    _ player: FRadioPlayer, playbackStateDidChange state: FRadioPlayer.PlaybackState
  ) {}
  public func radioPlayer(_ player: FRadioPlayer, itemDidChange url: URL?) {}
  public func radioPlayer(
    _ player: FRadioPlayer, metadataDidChange metadata: FRadioPlayer.Metadata?
  ) {}
  public func radioPlayer(_ player: FRadioPlayer, artworkDidChange artworkURL: URL?) {}
  public func radioPlayer(
    _ player: FRadioPlayer, playTimeDidChange currentTime: TimeInterval, duration: TimeInterval
  ) {}
  public func radioPlayer(_ player: FRadioPlayer, durationDidChange duration: TimeInterval) {}
}
