...
class AboutPageModel: ViewModel {
  ...
  func waitingListButtonTapped() {
    sendEmail(
      recipientEmail: "waitlist@playola.fm",
  ...
  var body: some View {
    ZStack {
      ...
      VStack {
        ...
        Text(
          "Please reach out and let us know what you think of our independent artist made radio stations."
        )
        ...
        Button(
          action: { model.feedbackButtonTapped() },
          label: {
            Text("Let Us Know")
              .bold()
              .padding()
        ...
        Button(
          action: { model.waitingListButtonTapped() },
          label: {
            Text("Join Waitlist")
              .bold()
              .padding()
